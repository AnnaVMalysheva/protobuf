...
import static com.example.protobuf.protobuf.BaeldungTraining.Student.*;
...
public class ProtobufApplication {
    ...
    private Student createStudent(int id, String firstName, String lastName, String email, List<PhoneNumber> phones) {
        return newBuilder().setId(id).setFirstName(firstName).setLastName(lastName).setEmail(email).addAllPhone(phones).build();
    }
